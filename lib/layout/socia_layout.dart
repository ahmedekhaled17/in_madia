...
import 'package:in_media/modules/name_screen/Name.dart';
import 'package:in_media/modules/new_post_screen/new_post_screen.dart';
import 'p'
    'ackage:in_media/shared/style/colors_manager.dart';
          ...
          appBar: AppBar(
            ...
            actions: [
              ...
              IconButton(
                  ...
                  onPressed: (){
                    Navigator.pushReplacement(context, SlidAnimation(
                        page: const Name(), alignment: AppConstant.topAlignment),);
                  }
              ),
            ],
          ),
